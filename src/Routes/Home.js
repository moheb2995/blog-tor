...
const topBlogs = topBlog.map(i=>
<div className='bg-orange-400 p-2 'key={i._id}>
  <Link to={`/SingleBlog/${i._id}`}> 
    <div className="">
    <img className='rounded-sm w-[100%] ' src={i.imgurl} alt="poto" />
...
if(!topBlog || !topUser)return <div className="shadow-xl p-4 text-center m-10">
